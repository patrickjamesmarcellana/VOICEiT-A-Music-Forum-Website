...
async function test() {
    ...
    await (new User({
        ...
        photoUrl: "images/melissa_spellman.png"
    })).save()
    ...
    await (new User({
        ...
        photoUrl: "images/draeznor_rock_lover.png"
    })).save()
    ...
    await (new User({
        ...
        photoUrl: "images/jennie_itgirl.png"
    })).save()
    ...
    await (new User({
        ...
        photoUrl: "images/marithus_25.png"
    })).save()

    await (new User({
        username: "aria_eagleheart",
        description: "aria_eagleheart",
        photoUrl: "images/aria_eagleheart.png"
    })).save()
